...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL||"http://localhost:8080/zk/ueditor/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,initialContent:"请输入通知内容！"    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
