...
import com.zhnjy.util.db.FilterDB;

public class CheckLevelFilter implements Filter{
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		if (check(path)) {// 路径需要检查
			...
			if(!FilterDB.isPermission(level, path)){
	...
	*/
	private boolean check(String path) {
		...
		if( packge.indexOf("css") == 0 || packge.equals("easyui") || packge.equals("file") || packge.equals("images") || packge.equals("jBox")|| packge.equals("js") || packge.equals("show_data_jsp") ){
			reBoolean = false;
				break;
			}
		}
